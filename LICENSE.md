...
**[Based on HL3-CORE (forked from Version 3.0, October 2021 to cover AI training)](https://firstdonoharm.dev/version/3/0/core.md)**
 ...
 * [3.3.](#3.3) The Licensee MAY use the Software for training artificial intelligence (AI) models if and only if the following conditions are met:  
   * [3.3.1.](#3.3.1) The AI models trained using the Software MUST comply with the Ethical Standards listed in Section 3.1 and 3.2 of this License.  
   * [3.3.2.](#3.3.2) The Software MUST be attributed as part of the training process, with proper acknowledgment of the Licensor’s work, including a visible reference to this License and its terms in documentation, publications, or similar materials describing the AI models.  
